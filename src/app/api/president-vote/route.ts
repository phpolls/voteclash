...
export async function POST(req: Request) {
  try {
    ...
    // ✅ Incognito defense via Supabase (shared across Vercel instances)
      ...
      return NextResponse.json(
        {
          ok: false,
          rateLimited: true,
          message: 'Too many presidential votes from this network. Try again later.',
        },
    ...
    // ✅ Hard one-vote-only enforcement (DB unique index inside cast_presidential_vote insert)
